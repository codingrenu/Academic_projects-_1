...
<!DOCTYPE html>
<html>
<?php $title="Bloodcarenetwork | home page"; ?>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <i class="fa fa-envelope"> </i> <a > donatewithcare@lifelinebloodcare.com</a><br><br>
                        <i class="fa fa-mobile"> </i> <a > +91 9003944506</a><br><br>
                    </div>
                </div>
            </div>
            </div>
        ...
        <div class="row mb-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="https://fourwellness.co/blog/31-simple-wellness-tips-for-healthy-and-happy-living" target="_blank">Healthy & Happy Living Tips</a><br>
